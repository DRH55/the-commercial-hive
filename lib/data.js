...
export const BADGES = [
  ...
  { id: "applicant", name: "Applicant", desc: "Applied to become a contributor" },
...
// `activity` shape: { articles: [...], responses: [...], replies: [...], applications: [...], contributorTier: string|null }
export function computeEarnedBadges(activity) {
  const { articles = [], responses = [], replies = [], applications = [], contributorTier } = activity;
